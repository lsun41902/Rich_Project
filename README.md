...
이 프로젝트는 mplfinance를 활용한 전문적인 캔들 차트 시각화와 더불어, 과거 데이터를 학습한 AI의 가격 예측 및 최신 DART 공시, 뉴스 요약 기능을 제공하여 투자 의사결정을 돕습니다.

![메인화면](example/메인_한국_증시.png)
...
![공시요약](example/공시_분석.png)
![뉴스요약](example/뉴스_분석.png)
...
### 7. 종목 관리
증권사 API에 의존하지 않고도 표준화된 데이터를 제공받아, 별도의 복잡한 설치 과정 없이 즉각적인 주가 정보를 가져올 수 있습니다.
![종목관리](example/종목_관리.png)

### 8. 상승주, 하락주 TOP20
당일 거래 대금과 등락률을 기준으로 상승 종목 및 하락 종목 TOP 20 리스트를 보여줍니다.
![종목관리](example/top20.png)
![종목관리](example/low20.png)

### 9. 미국 주식 시장
NASDAQ, NYSE, S&P 500 등 글로벌 시장의 데이터를 추가 하여 프로그램의 수요를 올렸습니다.
![종목관리](example/메인_미국_증시.png)
